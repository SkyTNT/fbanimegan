...
@click.option('--map-dim',    help='Mapping network dim  [default: varies]', metavar='INT', type=click.IntRange(min=1))
...
def main(**kwargs):
    ...
    c.G_kwargs.z_dim = c.G_kwargs.w_dim = 512 if opts.map_dim is None else opts.map_dim
